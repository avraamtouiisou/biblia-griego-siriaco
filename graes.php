...
echo '<tb class=d-block><a class=d-inline href="x.php?book='.$booko.'&chapter='.$chapter.'&verse='.$res['verse'].'&resources%5B%5D=tanslg&filtro=">'.$res['verse'].'</a>'./*$res['verse'].*/' <t class=d-inline>'.$textoGriego.'</t></tb>'.PHP_EOL;
